...
<section id="page-banner">
    <div class="banner" style="background: url('/wp-content/themes/postali-child/images/content_header_image.jpg') no-repeat; background-size:cover;">
        <div id="banner-container" class="container">
            <div class="headline-text">Legal Blog</div>
            <?php if( $ctaText ): ?>
...
<section class="page-content">
	<div class="container">
		...
		<div class="columns">
			<div class="column-66">
                <h1><?php the_title(); ?></h1>
                <div class="post-meta"><span class="post-meta-date"><?php the_date(); ?> by <a href="/about-pittsburgh-defense-attorney-michael-worgul/" title="Attorney Mike Worgul">Mike Worgul</a> in </span><span class="post-meta-categories"><?php the_category( ', ' ); ?></span></div>
