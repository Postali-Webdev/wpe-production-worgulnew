...
function create_custom_post_type_testimonial() {
...
function testimonial_topic() {
	...
	register_taxonomy( 'testimonial_topic', array( 'testimonial' ), $args );

}
add_action( 'init', 'testimonial_topic', 0 );
add_action( 'init', 'create_custom_post_type_testimonial' );